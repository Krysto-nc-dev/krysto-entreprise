  ...
  return (
    <Card className="relative w-full xl:w-[350px]">
      ...
      <CardContent className="text-sm text-muted-foreground">
        <p className="mb-2">
          Valeur totale de tous les tickets dans le pipeline donné, sauf la
          dernière colonne. Votre dernière colonne est considérée comme votre
          colonne de clôture dans chaque pipeline.
        </p>
        <Select
