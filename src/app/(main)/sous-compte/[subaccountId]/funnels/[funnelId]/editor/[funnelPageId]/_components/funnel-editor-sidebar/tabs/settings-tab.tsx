  ...
  return (
    ...
    >
      <AccordionItem
        ...
        className="px-6 py-0  "
      >
        <AccordionTrigger className="!no-underline">Customisation des liens</AccordionTrigger>
        <AccordionContent>
      ...
      >
        ...
        <AccordionContent className="flex flex-col gap-2 ">
          <div className="flex flex-col gap-2 ">
            <p className="text-muted-foreground">Alignement du texte</p>
            <Tabs
              onValueChange={(e) =>
                handleOnChanges({
                  target: {
          ...
          <div className="flex flex-col gap-2">
            <p className="text-muted-foreground">Police de texte</p>
            <Input
              id="DM Sans"
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <div className="flex gap-4 flex-col">
                <div className="flex gap-4">
                  <div>
                    <Label className="text-muted-foreground">Hauteur</Label>
                    <Input
                      id="height"
                      placeholder="px"
                      onChange={handleOnChanges}
                  ...
                  <div>
                    <Label className="text-muted-foreground">Largeur</Label>
                    <Input
                      placeholder="px"
                      id="width"
                      onChange={handleOnChanges}
              ...
              <div className="flex gap-4 flex-col">
                <div className="flex gap-4">
                  <div>
                    <Label className="text-muted-foreground">Haut</Label>
                    <Input
                      id="marginTop"
                      placeholder="px"
                      onChange={handleOnChanges}
                  ...
                  <div>
                    <Label className="text-muted-foreground">Bas</Label>
                    <Input
                      placeholder="px"
                      id="marginBottom"
                      onChange={handleOnChanges}
                ...
                <div className="flex gap-4">
                  <div>
                    <Label className="text-muted-foreground">Gauche</Label>
                    <Input
                      placeholder="px"
                      id="marginLeft"
                      onChange={handleOnChanges}
                  ...
                  <div>
                    <Label className="text-muted-foreground">Droite</Label>
                    <Input
                      placeholder="px"
                      id="marginRight"
                      onChange={handleOnChanges}
      ...
      >
        ...
        <AccordionContent className="flex flex-col gap-4">
          <div>
            <Label className="text-muted-foreground">Opacité</Label>
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Couleur de fond</Label>
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Image de fond</Label>
            <div className="flex  border-[1px] rounded-md overflow-clip">
              <div
                className="w-12 "
                style={{
          ...
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Position de l'image</Label>
            <Tabs
              onValueChange={(e) =>
                handleOnChanges({
                  target: {
