...
const ContactFormComponent = (props: Props) => {
  ...
  const onFormSubmit = async (
    ...
    try {
      ...
      await saveActivityLogsNotification({
        ...
        description: `Un nouveau contact c'est enregistré | ${response?.name}`,
        subAccountId: subaccountId,
      })
      toast({
        title: 'Success',
        description: 'Informations enregistré avec succées',
      })
      await goToNextPage()
    } catch (error) {
      toast({
  ...
  return (
    ...
    >
      ...
      <ContactForm
        subTitle="Contacter-nous"
        title="Besoins d'un devis"
