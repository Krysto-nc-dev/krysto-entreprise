...
subheading="Les colonnes vous permettent de regrouper des tickets"
      >
  ...
  return (
    ...
    <div className="bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in overflow-hidden">
