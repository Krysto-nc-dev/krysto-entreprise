...
const PipelineTicket = ({
  ...
  const handleClickEdit = async () => {
    setOpen(
      <CustomModal
        title="Mettre à jour les détails du ticket"
        subheading=""
      >
        <TicketForm
  ...
  const handleDeleteTicket = async () => {
    try {
      ...
      toast({
        title: 'Supprimé',
        description: 'Ticket supprimé de la colonne.',
      })

      await saveActivityLogsNotification({
        organisationId: undefined,
        description: `Suppression d'un ticket | ${response?.name}`,
        subAccountId: subaccountId,
      })
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      définitivement le ticket et le retirera de nos serveurs.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
